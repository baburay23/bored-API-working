...
var $author$project$Main$gifDecoder = A2($elm$json$Json$Decode$field, 'activity', $elm$json$Json$Decode$string);
var $author$project$Example$runGifDecoder = function (json) {
	return A2($elm$json$Json$Decode$decodeString, $author$project$Main$gifDecoder, json);
};
...
var $author$project$Example$decodesBoredGif = A2(
	$elm_explorations$test$Test$test,
	'Properly decodes the bored activity string',
	function (_v0) {
		var input = '\n                     { "activity":"Learn how to play a new sport" }\n                    ';
		var decodedOutput = $author$project$Example$runGifDecoder(input);
		return A2(
			$elm_explorations$test$Expect$equal,
			decodedOutput,
			$elm$core$Result$Ok('Learn how to play a new sport'));
	});
...
var $author$project$Test$Generated$Main4202318156$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/ababur/Desktop/learning/bored-API-working/tests/Example.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 287760362292023
	},
	$elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'Example',
				_List_fromArray(
					[$author$project$Example$decodesBoredGif]))
			])));
_Platform_export({'Test':{'Generated':{'Main4202318156':{'init':$author$project$Test$Generated$Main4202318156$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-46330.sock";
